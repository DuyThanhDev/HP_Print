...
import ProUVGoPage from "./page/proOfSidebar/proUVGoPage";
import ProUVDaPage from "./page/proOfSidebar/proUVDaPage";
    ...
    <Router>
      <div className="App">
        <Routes>
          ...
          <Route path="/proUVGo" element={<ProUVGoPage />} />
          <Route path="/proUVDa" element={<ProUVDaPage />} />
        </Routes>
      </div>
    </Router>
  );
